  ...
  return (
    <div className="mt-8">
      <div className="space-y-3">
        ...
        {(demoState.subPhase === "content" || demoState.subPhase === "user-question" || demoState.subPhase === "ai-answer") && (
          <motion.div 
            className="mt-6 space-y-4"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ 
              delay: 1.2 + (node.summary.length * 0.04) + (node.vocabulary.length * 0.6) + 0.5 
            }}
          >
            ...
            <div className="space-y-3">
              <div className="relative inline-block">
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  transition={{ 
                    delay: 1.2 + (node.summary.length * 0.04) + (node.vocabulary.length * 0.6) + 0.7, 
                    duration: 0.3 
                  }}
                >
